...
Icon.Image = "rbxassetid://120008128829681" -- Ícono personalizado
...
local XRNLFrame = Instance.new("Frame")
XRNLFrame.Name = "XRNLFrame"
XRNLFrame.Size = UDim2.new(0, 600, 0, 400)
XRNLFrame.Position = UDim2.new(0.5, -300, 0.5, -200)
XRNLFrame.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
XRNLFrame.Visible = false
XRNLFrame.Parent = ScreenGui
XRNLFrame.ZIndex = 999
XRNLFrame.Active = true
XRNLFrame.Draggable = true
        ...
        local Tabs = {
            ESP = Window:AddTab({ Title = "Juegos", Icon = "eye" }),
    ...
    if not success then warn('Error al cargar el panel:', err) end
end)
Icon.MouseButton1Click:Connect(function()
	XRNLFrame.Visible = not XRNLFrame.Visible
end)
